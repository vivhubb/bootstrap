...
(function (global, factory) {
  ...
  class Tab extends BaseComponent__default.default {
    ...
    _activate(element, relatedElem) {
      ...
      this._activate(index_js.getElementFromSelector(element)); // Search and activate/show the proper section
    ...
    _deactivate(element, relatedElem) {
      ...
      element.blur();
      this._deactivate(index_js.getElementFromSelector(element)); // Search and deactivate the shown section too
    ...
    _setInitialAttributesOnTargetPanel(child) {
      const target = index_js.getElementFromSelector(child);
      if (!target) {
        return;
      }
