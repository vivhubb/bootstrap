...
(function (global, factory) {
  ...
  class Collapse extends BaseComponent__default.default {
    constructor(element, config) {
      ...
      for (const elem of toggleList) {
        const selector = index_js.getSelectorFromElement(elem);
    ...
    hide() {
      ...
      for (const trigger of this._triggerArray) {
        const element = index_js.getElementFromSelector(trigger);
    ...
    _initializeChildren() {
      ...
      for (const element of children) {
        const selected = index_js.getElementFromSelector(element);
        if (selected) {
  ...
  EventHandler__default.default.on(document, EVENT_CLICK_DATA_API, SELECTOR_DATA_TOGGLE, function (event) {
    ...
    const selector = index_js.getSelectorFromElement(this);
